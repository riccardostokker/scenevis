...
@media(max-width:900px){.report-header{display:block}.count{margin-top:12px}.guide-grid,.scenario{grid-template-columns:1fr}}
@media print{main{padding:20px}.summary{break-inside:avoid}.guide-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.guide-grid article,.scenario{break-inside:avoid}.scenario{grid-template-columns:1.4fr 1fr;gap:20px;page-break-before:auto}.metrics li{break-inside:avoid}}
